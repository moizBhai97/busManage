...
class NameCopyWidget extends StatefulWidget {
  const NameCopyWidget({Key? key}) : super(key: key);

  @override
  _NameCopyWidgetState createState() => _NameCopyWidgetState();
}
        ...
        child: GestureDetector(
          ...
          child: Stack(
            children: [
              ...
              Align(
                alignment: AlignmentDirectional(-1.06, -0.74),
                child: Image.asset(
                  'assets/images/Screenshot_2022-12-05_143051.png',
                  width: 300,
                  height: 50,
                  fit: BoxFit.contain,
                ),
