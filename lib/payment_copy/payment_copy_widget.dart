import '../finalpay/finalpay_widget.dart';
      ...
      body: GestureDetector(
        ...
        child: Stack(
          children: [
            ...
            Align(
              alignment: AlignmentDirectional(-0.34, -0.43),
              child: ClipRect(
                child: ImageFiltered(
            ...
            Align(
              alignment: AlignmentDirectional(0.61, 0.48),
              child: FFButtonWidget(
                onPressed: () async {
                  await Navigator.pushAndRemoveUntil(
                    context,
                    MaterialPageRoute(
                      builder: (context) => FinalpayWidget(),
                    ),
                    (r) => false,
                  );
                },
            ...
            Align(
              alignment: AlignmentDirectional(-0.48, 0.48),
              child: FFButtonWidget(
                onPressed: () async {
                  await Navigator.pushAndRemoveUntil(
                    context,
